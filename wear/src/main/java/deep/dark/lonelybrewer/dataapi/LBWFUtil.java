...
public final class LBWFUtil {
    ...
    public static final String KEY_TIME_MODE = "TIME_MODE",
            KEY_BARRELS_COLOUR = "BARREL_COLOUR", KEY_CROPS_COLOUR = "CROPS_COLOUR",
            KEY_MAGMA_COLOUR = "MAGMA_COLOUR";

    public static final String PATH_WITH_FEATURE = "/watch_face_config/LonelyBrewerWatchFace";

    public static final int IS_12H_MODE_ON_DEFAULT = 1, BARRELS_COLOUR_DEFAULT = Color.YELLOW,
